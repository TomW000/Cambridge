...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def get_d_closest_elements(self, embeddings, reference_emb, d=0.1, normalize_distances=True, verbose=False, chunk_size=100):
        g = self.get_d_closest_elements_gen(embeddings, reference_emb, d=d, normalize_distances=normalize_distances, verbose=verbose, chunk_size=chunk_size)
        dataset = []
        ...
        print(f'{100*len(dataset)/nb_embeddings}% of embeddings were below the threshold')
        return dataset
