from setup import model, device, feat_dim, resize_size, dataset_path, tqdm, torch, np, os, h5py
...
if __name__=='__main__':  # Fixed: Added double underscores
    ...
    all_latents, all_labels = get_latents(dataset_paths=data, labels=labs, k=5)

    print('Preparing display 1')
