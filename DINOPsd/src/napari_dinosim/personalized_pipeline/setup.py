...
few_shot_transforms = [Trans.ToTensor(),
                       Trans.Compose([Trans.ToTensor(), Trans.RandomResizedCrop(100)]),       
                       Trans.Compose([Trans.ToTensor(), Trans.RandomHorizontalFlip()]),      
                       Trans.Compose([Trans.ToTensor(), Trans.ColorJitter(0.4, 0.4, 0.4)]),  
                       Trans.Compose([Trans.ToTensor(), Trans.RandomRotation(15)])
                       ]
