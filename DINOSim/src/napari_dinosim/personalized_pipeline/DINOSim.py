from setup import umap, torch, tqdm, np, px, PCA, device, model, feat_dim, resize_size
...
if __name__=='__main__':  # Fixed: Added double underscores
    ...
    for dataset, label in tqdm(zip(datasets, _labels), desc='Iterating through neurotransmitters'):
