from setup import gaussian_kernel, torch, torch_convolve, h5py, dates, neurotransmitters, glob, np, device, os, few_shot, crop_shape, upsample, plt, pd, sns, Counter
...
def get_fnames():
    ...
    return np.concatenate(files), np.concatenate(labels)
